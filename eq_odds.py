...
# PENDING: indices for the datagroups

class EqOddsModel:

    def __init__(self, clf, group_col=1, group_vals=[0, 1]):
        self.clf = clf
    ...
    def train(self, trainX, trainY, trainZ):
        ...
        group_0_val_model = Model(np.array(group_0_preds), np.array(group_0_label))
        group_1_val_model = Model(np.array(group_1_preds), np.array(group_1_label))
